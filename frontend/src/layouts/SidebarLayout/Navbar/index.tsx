...
// import { resetNoti } from '../../../features/notification/notification.slice';
...
const SidePanelNavbar = (props: propsType) => {
    ...
    const { bell } = useAppSelector((state) => state.notification)
        ...
        <Box className={styles.root}>
            ...
            <Box className={styles.right}>
                ...
                <Box sx={{ cursor: 'pointer', color: bell ? "red" : "black" }} className={styles.notificationBox}
                    // onClick={() => {navigate('/notification'); dispatch(resetNoti()) ;  }}
                     >
                    {
