            ...
            <Box className={styles.profileWrap}>
                ...
                <Box className={styles.profile}>
                    ...
                    <Box className={styles.profileTextWrap}>
                        <Typography className={styles.name}>{user.first_name} </Typography>
                    ...
                    <Grid item xs={6}>
                        <Grid item xs={12} className={styles.inputWraper}>
                            <FormGroup>
                                ...
                                <InputBase disabled onChange={(e: e) => { setData((pre: data) => ({ ...pre, first_name: e.target.value })) }} value={data?.first_name} placeholder='First Name' type='text' className={`${styles.inputBox}`} />
                            </FormGroup>
                        </Grid>
                        <Grid item xs={12} className={styles.inputWraper}>
                            <FormGroup>
